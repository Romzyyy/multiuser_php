...
<body>
    <nav class="navbar navbar-expand-lg bg-light">
        <div class="container-fluid w-50">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="../halaman_siswa/siswa.php">Siswa</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container-fluid mt-5">
        ...
        <div class="container-fluid w-75 position-relative">
            <a class="btn btn-success" href="tambah_mapel.php" role="button">Add New</a>
            ...
            while ($tampil = mysqli_fetch_array($data)){
              ...
              <tr>
                  ...
                  <a class='btn btn-primary' href='ubah_mapel.php?kode=$tampil[id]' role='button'>Edit</a>
...
include "../../koneksi.php";
if(isset($_GET['kode'])){
mysqli_query($koneksi, "delete from matapelajaran where id='$_GET[kode]'");
